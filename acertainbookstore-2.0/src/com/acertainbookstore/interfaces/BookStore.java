...
/**
 * BookStore declares the methods exposed by the bookstore to the clients. These methods need to be implemented by both the server and the client end.
 * 
 */
public interface BookStore {
	...
	/**
	 * Applies the BookRatings in the set, i.e. rates each book with their respective rating.
	 * 
	 * @param bookRating
	 * @return
	 * @throws BookStoreException
