...
/**
 * StockManagerHTTPProxy implements the client level synchronous CertainBookStore API declared in the BookStore class
 * 
...
public class StockManagerHTTPProxy implements StockManager {
	...
	public void clear() {
		...
		String urlString = serverAddress + "/" + BookStoreMessageTag.CLEAR;
	...
	public void updateEditorPicks(Set<BookEditorPick> editorPicksValues) throws BookStoreException {
		...
		String xmlStringEditorPicksValues = BookStoreUtility.serializeObjectToXMLString(editorPicksValues);
	...
	public List<StockBook> getBooksInDemand() throws BookStoreException {
		String urlString = serverAddress + "/" + BookStoreMessageTag.GETINDEMAND;
