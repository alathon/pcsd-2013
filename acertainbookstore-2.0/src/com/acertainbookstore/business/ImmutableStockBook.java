...
/**
 * The book object that gets sent back to the StockManager. We do not allow the StockManager to make any changes to the data structure. The member functions are commented in the
 * StockBook interface instead of here.
 * 
 */
public final class ImmutableStockBook extends ImmutableBook implements StockBook {
	 ...
	 * @param editorPick
	 */
	public ImmutableStockBook(int ISBN, String title, String author, float price, int numCopies, long SaleMisses, long timesRated, long totalRating, boolean editorPick) {
