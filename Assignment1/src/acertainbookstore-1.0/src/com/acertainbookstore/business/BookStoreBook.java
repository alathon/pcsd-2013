...
/**
 * The implementation of all parts of the book. Only parts of it are available in the BookStoreClient and StockManager, cf. the Book interface and the StockBook interface.
 * 
 */
public class BookStoreBook extends ImmutableBook {
	...
	/**
	 * Sets the number of times that a client wanted to buy a book when it was not in stock.
	 * 
	 * @param saleMisses
	 */
	...
	/**
	 * Sets the book to be an editor pick if the boolean is true, otherwise the book is not an editor pick.
	 * 
	 * @param editorPick
	 */
	...
	/**
	 * Returns True if someone tried to buy the book, while the book was not in stock.
	 * 
	 * @return
	 */
	...
	public String toString() {
		String bookString = "ISBN = " + this.getISBN() + ", Title = " + this.getTitle() + ", Author = " + this.getAuthor() + ", Price = " + this.getPrice();
		return bookString;
	}
	...
	public ImmutableBook immutableBook() {
		return new ImmutableBook(this.getISBN(), new String(this.getTitle()), new String(this.getAuthor()), this.getPrice());
	}
	...
	public StockBook immutableStockBook() {
		return new ImmutableStockBook(this.getISBN(), new String(this.getTitle()), new String(this.getAuthor()), this.getPrice(), this.numCopies, this.saleMisses, this.timesRated,
				this.totalRating, this.editorPick);
	}
	...
	public BookStoreBook copy() {
		return new BookStoreBook(this.getISBN(), new String(this.getTitle()), new String(this.getAuthor()), this.getPrice(), this.numCopies);
	}
